...
const SEO_DESCRIPTION =
  "Chat with the Nomad agent about visa windows, tax-residency day counts, and where you can safely be next.";
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-background">
      <AgentChatSurface
        ...
        suggestions={[
          t("chat.suggestionDaysLeft"),
          t("chat.suggestionLogTrip"),
          t("chat.suggestionWhereNext"),
        ]}
